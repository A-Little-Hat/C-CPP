...
class matrix{
	...
	public: matrix();
			...
			display();
			trans();
			friend void diff(matrix<T> &,matrix<T> &,matrix<T> &);
			friend void add(matrix<T> &,matrix<T> &,matrix<T> &);
			friend void prod(matrix<T> &,matrix<T> &,matrix<T> &);
 ...
 void add (matrix m1,matrix m2,matrix result)
{
 ...
 void diff(matrix m1,matrix m2,matrix result)
{
		for(int i=0;i<m1.r;i++)
	{
		for(int j=0;j<m1.c;j++)
 ...
 void prod(matrix m1,matrix m2,matrix result)
{
	for(int i=0;i<r1;i++)
		{
		for(int j=0;j<c2;j++)
